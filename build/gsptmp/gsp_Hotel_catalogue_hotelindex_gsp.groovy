...
class gsp_Hotel_catalogue_hotelindex_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/hotel/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(10)
invokeTag('table','f',22,['collection':(hotelList)],-1)
printHtmlPart(11)
invokeTag('paginate','g',25,['total':(hotelCount ?: 0)],-1)
printHtmlPart(12)
})
