...
class gsp_Hotel_catalogue_countryshow_gsp extends org.grails.gsp.GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/country/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("country")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.country)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.country),'method':("DELETE")],2)
printHtmlPart(17)
})
...
public static final long LAST_MODIFIED = 1598194545224L
